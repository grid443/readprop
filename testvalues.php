...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>readprop/testvalues.php at master · azEsm/readprop</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="55EA2555:77B9:162A28:52E0DF3C" name="octolytics-dimension-request_id" /><meta content="1201540" name="octolytics-actor-id" /><meta content="azEsm" name="octolytics-actor-login" /><meta content="a2d0bac9d90f1dc33f3fa5859200ff95d6eca35c29696a3381a9930111de980a" name="octolytics-actor-hash" />
...
<meta content="cE1QBlNwqsFRjH6i9+1Yw0AwDr06a8y+pMOvY9sKVGA=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-d23a1b1c4a1bc509a0ca67face2fb37ef257f599.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="8f007ab25b2862b49b903b61e0526105">
        ...
        <link data-pjax-transient rel='permalink' href='/azEsm/readprop/blob/3db825aac52fdeb4828a165f6bd589968f72eeb3/testvalues.php'>
...
<!-- blob contrib key: blob_contributors:v21:d4a1d264806627654baf73ea1d778fcf -->
...
<div class="select-menu js-menu-container js-select-menu" >
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/azEsm/readprop/blob/master/testvalues.php"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
          ...
          <form accept-charset="UTF-8" action="/azEsm/readprop/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="cE1QBlNwqsFRjH6i9+1Yw0AwDr06a8y+pMOvY9sKVGA=" /></div>
            ...
            <input type="hidden" name="path" id="path" value="testvalues.php" />
  ...
  <div class="commit file-history-tease">
    ...
    <time class="js-relative-date" datetime="2014-01-21T01:17:19-08:00" title="2014-01-21 01:17:19">January 21, 2014</time>
    <div class="commit-title">
        <a href="/azEsm/readprop/commit/7e35ce59e7e0a9df1f3df59dc89f9b6002d862da" class="message" data-pjax="true" title="deleted excess string from test function">deleted excess string from test function</a>
    </div>
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped leftwards"
               href="github-windows://openRepo/https://github.com/azEsm/readprop?branch=master&amp;filepath=testvalues.php" title="Open this file in GitHub for Windows">
                <span class="octicon octicon-device-desktop"></span> Open
            </a>
                <a class="minibutton"
                   href="/azEsm/readprop/edit/master/testvalues.php"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/azEsm/readprop/raw/master/testvalues.php" class="button minibutton " id="raw-url">Raw</a>
            <a href="/azEsm/readprop/blame/master/testvalues.php" class="button minibutton ">Blame</a>
          <a href="/azEsm/readprop/commits/master/testvalues.php" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          <a class="minibutton danger empty-icon tooltipped downwards"
             href="/azEsm/readprop/delete/master/testvalues.php"
             title=""
...
<span id="L33" rel="#L33">33</span>
            ...
            <td class="blob-line-code">
                    <div class="code-body highlight"><pre><div class='line' id='LC1'><span class="o">&lt;?</span><span class="nx">php</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="k">function</span> <span class="nf">testvalues</span><span class="p">(</span><span class="nv">$array</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="nv">$whatineed</span> <span class="o">=</span> <span class="k">Array</span> </div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">(</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;1&quot;</span> <span class="o">=&gt;</span> <span class="s2">&quot;2&quot;</span><span class="p">,</span> </div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;test&quot;</span> <span class="o">=&gt;</span> <span class="s2">&quot;test&quot;</span><span class="p">,</span> </div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;sing&quot;</span> <span class="o">=&gt;</span> <span class="s2">&quot;ping&quot;</span><span class="p">,</span> </div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;Скотч&quot;</span> <span class="o">=&gt;</span> <span class="s2">&quot;Swatch&quot;</span><span class="p">,</span> </div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;Авот&quot;</span> <span class="o">=&gt;</span> <span class="s2">&quot;Ашот=Крот&quot;</span><span class="p">,</span> </div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="s2">&quot;Ктор&quot;</span> <span class="o">=&gt;</span> <span class="s2">&quot;Фтор&quot;</span> </div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">);</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">foreach</span> <span class="p">(</span><span class="nv">$whatineed</span> <span class="k">as</span> <span class="nv">$key</span> <span class="o">=&gt;</span> <span class="nv">$value</span><span class="p">)</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">{</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nv">$whatineed</span><span class="p">[</span><span class="nv">$key</span><span class="p">]</span> <span class="o">==</span> <span class="nv">$array</span><span class="p">[</span><span class="nv">$key</span><span class="p">])</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">{</span></div><div class='line' id='LC20'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nv">$result</span><span class="p">[</span><span class="nv">$key</span><span class="p">]</span> <span class="o">=</span> <span class="s2">&quot;true&quot;</span><span class="p">;</span></div><div class='line' id='LC21'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">else</span></div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">{</span></div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nv">$result</span><span class="p">[</span><span class="nv">$key</span><span class="p">]</span> <span class="o">=</span> <span class="s2">&quot;false&quot;</span><span class="p">;</span></div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC28'><br/></div><div class='line' id='LC29'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">return</span> <span class="nv">$result</span><span class="p">;</span></div><div class='line' id='LC30'><br/></div><div class='line' id='LC31'><span class="p">}</span></div><div class='line' id='LC32'><br/></div><div class='line' id='LC33'><span class="cp">?&gt;</span><span class="x"></span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.03218s from github-fe119-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
